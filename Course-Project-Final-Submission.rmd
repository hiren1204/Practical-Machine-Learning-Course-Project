...
```
From the Decision Tree Model we get the prediction accuracy is 57% which is not upto satisfactory level.   
...
From Random Forest we get 98.9% (~99%) accuracy which is close to perfect accuracy level.

# Conclusion

we conclude that, Random Forest is accurate than Decision Tree and get upto 99% of accuracy level.   

Now, We will test on "test_data" 
